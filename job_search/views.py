...
from django.shortcuts import render
JOB_DATA_PATH = "C:/Users/Sameer/Desktop/Job Project/job_search/data/job_data.xlsx"

def load_jobs_from_excel():
    file_path = "C:/Users/Sameer/Desktop/Job Project/job_search/data/job_data.xlsx"
    try:
...
def parse_skills(resume_text):
    ...
    with open("C:/Users/Sameer/Desktop/Job Project/scripts/skills_db.json", "r") as file:
